...
namespace FeedCast
{
    public partial class App : Application
    {
        ...
        public static DataUtils DataBaseUtility { get; private set; }

        public static Settings ApplicationSettings { get; private set; }

        public static WebTools SynFeedDownloader { get; set; }

        public static Category Favorites { get; set; }

        public static string[] ArticleSource { get; set; }
        ...
        private void RootFrame_Navigating(object sender, NavigatingCancelEventArgs e)
        {
            ...
            else
            {
                if (Settings.InitialLaunchSetting)
                {
                    ...
                    e.Cancel = true;
                    //Sync new navigation
                    RootFrame.Dispatcher.BeginInvoke(() => { RootFrame.Navigate(new Uri("/Views/LaunchPage.xaml", UriKind.Relative)); });
                }
            }
        }
        #endregion
